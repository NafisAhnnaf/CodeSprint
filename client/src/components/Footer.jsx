...
//import footerBgLottie from "/footer-background.json"; // Replace with your Lottie file
...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full overflow-hidden text-white py-8">
      {/* Background Lottie */}
      <Player
        src={"/footer-background.json"} // Replace with your footer background Lottie JSON path
      ...
      <div className="relative z-10 text-center space-y-2">
        ...
        >
          © 2025 <span className="text-cyan-400 font-semibold">CodeSprint</span>
          . All rights reserved.
        </motion.p>
        ...
        >
          ...
          <span className="text-cyan-400 font-semibold">Team Dhongorsho</span>
        </motion.p>
      </div>
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Unauthorized copying, distribution, or use of this application
                or its components is strictly prohibited. This software is
                licensed to <strong>Team Dhongorsho</strong>
